...
export const tasksAPI = {
  ...
  projectReport: (id) => api.get(`/v1/tasks/projects/${id}/report/`),
  ...
  checklist: (id) => api.get(`/v1/tasks/${id}/checklist/`),
  addChecklistItem: (id, data) => api.post(`/v1/tasks/${id}/checklist/`, data),
  updateChecklistItem: (taskId, itemId, data) => api.patch(`/v1/tasks/${taskId}/checklist/${itemId}/`, data),
  deleteChecklistItem: (taskId, itemId) => api.delete(`/v1/tasks/${taskId}/checklist/${itemId}/`),
